...
namespace MedLab_Task.ViewModels
{
    ...
    {
        public BindableCollection<KnowledgeService.KnowledgeItem> kb_KnowledgeItems { get; set; }

        public MainViewModel()
        {
            KnowledgeService.KnowledgeBase kb = MainModel.GetKnowledgeBase(90);
            kb_KnowledgeItems = new BindableCollection<KnowledgeService.KnowledgeItem>(kb.knowledgeItems);
